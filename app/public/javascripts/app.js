(function() {
        ...
        function($compile) {
            return {
                ...
                link: function(scope, element, attrs) {
                    ...
                    if (element.hasClass('gs-compiled'))
                        return;

                    var addedClass = attrs.checkDevice;
                    // now lets check the device.
                    var ios = navigator.userAgent.match(/(iPad|iPhone|iPod)/g) ? true : false;

                    if (addedClass === 'fixed-row-background' && ios)
                        addedClass = 'cover-background';

                    if (!element.hasClass(addedClass)) {
                        element.addClass(addedClass);
                        element.addClass('gs-compiled');
    ...
    .directive('onRender', ["LoadPage", "$location", "$anchorScroll",
        function(LoadPage, $location,$anchorScroll) {
            return {
                restrict: 'A',
                link: function(scope, element, attrs) {
    ...
    .factory('LoadPage', ["$q", "$timeout", "$interval", "Intercom",
        function($q, $timeout, $interval, Intercom) {
    ...
    .controller('ServiceCtrl', ["$scope", "Title", "Router",
        function($scope, Title, Router) {
            ...
            $scope.$watch('activePortal', function() {
                ...
                title = (title === 'guernica Softworks' || title === '') ? "guernica Softworks" :  "guernica Softworks, " + title;
                Title.set(title);
            });
    ...
    .controller('ClientCtrl', ["$scope", "Intercom", "LoadPage", "Models", "Router", "Title",
        function($scope, Intercom, LoadPage, Models, Router, Title) {
        ...
        .controller('ContactCtrl', ["$scope", "Intercom", "LoadPage", "$rootScope", "Models", "Router", "Title",
            function($scope, Intercom, LoadPage, $rootScope, Models, Router, Title) {
