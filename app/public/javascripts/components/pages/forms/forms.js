(function() {
 ...
 .directive('formsPage', ["$q", "$http", "Constants", "Intercom", "LoadPage", function($q, $http, Constants, Intercom, LoadPage) {
     return {
         restrict: 'E',
         ...
         controller: ["$scope", function($scope) {
             ...
             var run = (function($scope, $q, $http, Constants, Intercom, LoadPage) {
            ...
            run($scope, $q, $http, Constants, Intercom, LoadPage);

            Intercom.on($scope,'form-altered', function() {
                //console.log($scope);
                // run($scope, $q, $http, Constants, Intercom, LoadPage);
            });
