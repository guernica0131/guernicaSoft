(function() {
    ...
    angular.module('gSoft.social', [])
        ...
        .run([
         ...
         .directive('social', ["SocialRender",  "Intercom", "LoadPage", function(SocialRender, Intercom, LoadPage) {
        return {
            restrict: 'E',
              ...
              link: function(scope, element, attrs) {
                ...
                function renderPinItButton() {
                    if (!scope.pinIt) {
                        ...
                        element.html('<a href="//www.pinterest.com/pin/create/button/?url=' + scope.pinItUrl + '&media=' +  $location.absUrl().replace($location.path(), '/' ) + ImageLocation.retrieve({name: scope.pinItImage, request: scope.pinType}) + '&description=' + scope.pinIt + '" data-pin-do="buttonPin" data-pin-config="beside"><img src="//assets.pinterest.com/images/pidgets/pinit_fg_en_rect_gray_20.png" alt="" /></a>');
