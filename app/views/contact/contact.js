(function() {
    ...
    .controller('ContactCtrl', ["$scope", "Constants", "Intercom", "LoadPage", "$rootScope", "Title",
        function($scope, Constants, Intercom, LoadPage, $rootScope, Title) {

            Title.set("Contact a guernica Softwork's professional");
